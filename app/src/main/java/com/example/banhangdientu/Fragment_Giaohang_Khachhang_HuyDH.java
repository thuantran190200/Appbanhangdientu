...
public class Fragment_Giaohang_Khachhang_HuyDH extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment__giaohang__khachhang__huy_d_h, container, false);
        recyclerView = view.findViewById(R.id.recyclerview_kh_HuyDH);
        return view;
    }
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if(listhoadon.size() == 0){
                    ...
                    fragmentTransaction.replace(R.id.kh_huyDH, fragment);
