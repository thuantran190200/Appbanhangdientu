...
public class Fragment_Giaohang_Khachhang_dagiao extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment__giaohang__khachhang_dagiao, container, false);
        recyclerView = view.findViewById(R.id.recyclerview_kh_dagiao);
        return view;
    }
    private void DataFromFirebaseListener() {
        listhoadon = new ArrayList<>();
        Query query = reference.orderByChild("trangthaiGH").equalTo("Đã Giao");
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if(listhoadon.size() == 0){
                    ...
                    fragmentTransaction.replace(R.id.kh_dagiao, fragment);
