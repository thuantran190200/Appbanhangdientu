...
public class Fragment_Giaohang_Nhanvien_choxacnhan extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,@Nullable ViewGroup container,@Nullable  Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.fragment__giaohang__nhanvien_choxacnhan, container, false);
        recyclerView = view.findViewById(R.id.recyclerview_nv_choxacnhan);
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if(listhoadon.size() == 0){
                    ...
                    fragmentTransaction.replace(R.id.nv_choxacnhan, fragment);
