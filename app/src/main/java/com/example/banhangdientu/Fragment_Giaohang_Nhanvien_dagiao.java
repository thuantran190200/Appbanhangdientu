...
public class Fragment_Giaohang_Nhanvien_dagiao extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,@Nullable ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment__giaohang__nhanvien_dagiao, container, false);
        recyclerView = view.findViewById(R.id.recyclerview_nv_dagiao);
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if(listhoadon.size() == 0){
                    ...
                    fragmentTransaction.replace(R.id.nv_dagiao, fragment);
